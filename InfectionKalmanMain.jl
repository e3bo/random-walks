...
res, n, r, s, x, pk, pkk = InfectionKalman.fit(cdata, pdata; betasd = pfixed.betasd[1], N = pfixed.N[1], a = pfixed.a[1], show_trace = true, detailed_results = true, time_limit = 600)
